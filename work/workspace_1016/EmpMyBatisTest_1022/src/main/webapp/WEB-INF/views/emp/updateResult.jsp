	...
	<form action="update" method="get">
		<div id="main">
			...
			<div id="list">
				...
				<p id="empNo_display">Employee Number : ${empInfo.empNo}</p>
				...
				<div id="list_data">
					...
					<div>Employee Name : 
						<input type="text" id="eName" name="eName" value="${empInfo.eName}"
						 onblur="checkField(this)" onfocus="clearField(this)">
					</div>
					<div>Job : 
						<input type="text" id="job" name="job" value="${empInfo.job}"
						onblur="checkField(this)" onfocus="clearField(this)">
					</div>
					<div>MGR : 
						<input type="text" id="mgr" name="mgr" value="${empInfo.mgr}"
						onblur="checkField(this)" onfocus="clearField(this)">
					</div>
