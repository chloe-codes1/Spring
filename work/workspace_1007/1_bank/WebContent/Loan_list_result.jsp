...
<title>Your Loan Account Info.</title>
...
<div id="main"> 
<c:forEach var="data" items="${loan_list}">
				...
				<div id="list">
						...
						<div class="rows">
						<span>Period of Loan : </span>${data.accountPeriod}
						</div>
						<div class="rows">
						<span>Amount of Loan : </span>${data.loan}
						</div>
						<div class="rows">
						...
						<div class="rows">
						<span>Monthly Payment : </span>${data.monthlyRA}
						</div>
				</div>
				</c:forEach>
