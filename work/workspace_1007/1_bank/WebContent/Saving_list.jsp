...
#span_username, #span_accountNumber{
...
<p id="title_text2"> Your Form Has Been Successfully Submitted. <br><br>

Account Number : <span id="span_accountNumber">${accountNumber}</span>
</p>
